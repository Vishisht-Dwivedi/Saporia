-- CreateEnum
CREATE TYPE "Role" AS ENUM ('CUSTOMER', 'RESTAURANT', 'DELIVERY');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING_RESTAURANT', 'PENDING_DELIVERY', 'OUT_FOR_DELIVERY', 'DELIVERED', 'REJECTED');
